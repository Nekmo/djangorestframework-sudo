...
PACKAGE_NAME = 'djangorestframework-sudo'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/djangorestframework-sudo/archive/master.zip'
MODULE = 'rest_framework_sudo'
REQUIREMENT_FILE = 'requirements.txt'
STATUS_LEVEL = 5  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['djangorestframework-sudo']
LICENSE = 'MIT license'
